...
'app.aliases.Storage','app.aliases.URL','app.aliases.Validator','app.aliases.View','auth.defaults.guard',
...
'cache.stores.octane.driver','cache.stores.apc.driver','cache.prefix','database.default','database.connections.sqlite.driver',
'database.connections.sqlite.database','database.connections.sqlite.prefix','database.connections.sqlite.foreign_key_constraints','database.connections.mysql.driver','database.connections.mysql.host',
...
'web','api',);
        registerArgumentsSet('routes', 'project.index','project.create','project.store',
'project.show','project.edit','project.update','project.destroy','sitemap.check',
'sitemap.output','sitemap.index','sitemap.create','sitemap.store','sitemap.show',
'sitemap.edit','sitemap.update','sitemap.destroy','visualfeedback.index','visualfeedback.create',
'visualfeedback.store','visualfeedback.show','visualfeedback.edit','visualfeedback.update','visualfeedback.destroy',);
        registerArgumentsSet('views', 
'index','layout','sitemap.index','sitemap.output','sitemap.output-tree',
'visualfeedback.index','welcome','laravel-exceptions-renderer::components.card','laravel-exceptions-renderer::components.context','laravel-exceptions-renderer::components.editor',
